...
const DEFAULT_ADMIN_USERS = [
  ...
  },
  {
    ...
    twoFactorEnabled: true,
    location: "Đà Nẵng",
    notes: "Tài khoản đang bị khóa tự động do phát hiện đăng nhập bất thường từ IP lạ.",
    createdAt: "2026-02-04T14:45:00+07:00",
    updatedAt: "2026-03-14T03:28:00+07:00",
    lastLogin: "2026-03-14T03:26:00+07:00",
...
const DEFAULT_ADMIN_LOGS = [
  ...
  },
  {
    ...
    outcome: "success",
    ipAddress: "10.24.6.18",
    description: "Khóa user do 5 lần đăng nhập sai liên tiếp từ IP 203.113.7.46.",
  },
  {
    id: "LOG-20260314-003",
  ...
  {
    id: "LOG-20260314-004",
    timestamp: "2026-03-14T07:14:00+07:00",
    severity: "warning",
    moduleKey: "security",
    moduleLabel: "Security",
    action: "Phát hiện đăng nhập IP lạ",
    actorName: "System Guard",
    actorUserName: "system.guard",
    actorUserId: "SYSTEM",
    targetId: "USR-1004",
    targetLabel: "Phạm Gia Hân",
    outcome: "warning",
  ...
  {
    id: "LOG-20260313-010",
    timestamp: "2026-03-13T21:12:00+07:00",
    severity: "info",
    moduleKey: "logs",
