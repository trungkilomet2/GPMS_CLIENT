...
export const BREADCRUMB_CONFIG = [
  ...
  { path: "/admin/users", label: "Quản lý user" },
  ...
  { path: "/admin/logs", label: "Nhật ký hệ thống", parent: "/admin/users" },
  { path: "/admin/permissions", label: "Quản lý phân quyền", parent: "/admin/users" },
